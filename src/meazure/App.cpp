...
#include "position/PositionLogMgr.h"
...
BOOL App::InitInstance() {
    ...
    //
    appFrame->SetCommandLineFile(cmdLineInfo.m_strFileName);

    // Create and load the frame with its resources
    //
    appFrame->LoadFrame(IDR_MAINFRAME, WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX, nullptr, nullptr);

    InterlockedExchange64(reinterpret_cast<LONG64*>(const_cast<HWND*>(&g_meaMainWnd)),
                          reinterpret_cast<LONG64>(appFrame->m_hWnd));
