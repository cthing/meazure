...
static double _Interpolate(double start, double end, int percent)
{
...
COLORREF MeaColors::InterpolateColor(COLORREF startRGB, COLORREF endRGB, int percent)
{
    ...
    hsl.hue         = _Interpolate(startHSL.hue, endHSL.hue, percent);
    hsl.saturation  = _Interpolate(startHSL.saturation, endHSL.saturation, percent);
    hsl.lightness   = _Interpolate(startHSL.lightness, endHSL.lightness, percent);
